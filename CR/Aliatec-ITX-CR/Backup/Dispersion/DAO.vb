...
Public Class DAO
    ...
    Private Const LayoutDispersionHSBC_ALI As String = "sp_Reporte_LayoutDispersionHSBC_ALI '@IdRazonSocial','@IdTipoNominaAsig','@IdTipoNominaProc','@Anio','@Periodo','@UID','@LID','@idAccion'"
